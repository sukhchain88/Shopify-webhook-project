...
export class QueueService {
   ...
   */
  static async sendEmail(data: EmailJobData, options?: Partial<JobsOptions>) {
   ...
   */
  static async sendBulkEmails(emails: EmailJobData[], options?: { 
    delayBetween?: number; 
    priority?: number;
  }) {
   ...
   */
  static async scheduleEmail(data: EmailJobData, scheduleTime: Date, options?: Partial<JobsOptions>) {
   ...
   */
  static async processWebhook(data: WebhookJobData, options?: Partial<JobsOptions>) {
   ...
   */
  static async processShopifyWebhook(data: ShopifyWebhookJobData, options?: Partial<JobsOptions>) {
   ...
   */
  static async syncProduct(data: ProductSyncJobData, options?: Partial<JobsOptions>) {
   ...
   */
  static async syncAllProducts(shopDomain?: string, options?: Partial<JobsOptions>) {
   ...
   */
  static async scheduleBackgroundTask(data: BackgroundTaskJobData, options?: Partial<JobsOptions>) {
   ...
   */
  static async scheduleDataCleanup(parameters: Record<string, any> = {}, options?: Partial<JobsOptions>) {
    const data: BackgroundTaskJobData = {
      taskType: 'cleanup',
      parameters: {
        olderThan: 30, // days
   ...
   */
  static async processOrder(data: OrderProcessingJobData, options?: Partial<JobsOptions>) {
   ...
   */
  static async sendNotification(data: NotificationJobData, options?: Partial<JobsOptions>) {
   ...
   */
  static async retryFailedJob(queueName: keyof typeof queues, jobId: string) {
    try {
   ...
   */
  static async cleanCompletedJobs(olderThan: number = 24 * 60 * 60 * 1000) {
   ...
   */
  private static getNotificationPriority(urgency?: 'low' | 'normal' | 'high' | 'critical'): number {
    switch (urgency) {
   ...
   */
  static addCorrelationId<T extends { correlationId?: string }>(data: T): T {
